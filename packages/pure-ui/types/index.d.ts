...
interface PureUiLocale {}
interface PureUiProps {}
...
export interface PureButtonProps extends PureUiProps {
  /**
   * 按钮类型语义化
   */
...
export type PureButtonEvents = any;
export type PureButtonSlots = any;
export class PureButton extends SvelteComponentTyped<
  PureButtonProps,
  PureButtonEvents,
  PureButtonSlots
> {}
